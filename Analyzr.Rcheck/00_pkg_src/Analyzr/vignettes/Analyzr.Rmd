...
The Analyzr package is designed to assist in preprocessing and investigation of a data file before beginning data analysis. It is intended to provide simple and easy to understand feedback about your data file, while also preparing output files and new data files to be used with subsequent packages. It summarizes variable type and count, if character variables are present, missingness, and normality testing. It will not provide normality testing if there is missingness present.
